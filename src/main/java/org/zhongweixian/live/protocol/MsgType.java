 ...
 * </pre>
 *
 * Protobuf enum {@code src.main.proto.MsgType}
 */
public enum MsgType
   ...
   * </pre>
   *
   * <code>MSG_TYPE_JOIN_GROUP = 7;</code>
   */
   ...
   * <code>MSG_TYPE_PERSION = 6;</code>
   */
  public static final int MSG_TYPE_PERSION_VALUE = 6;
  /**
   * <pre>
   *入群申请
   * </pre>
   ...
   * <code>MSG_TYPE_JOIN_GROUP = 7;</code>
   */
  public static final int MSG_TYPE_JOIN_GROUP_VALUE = 7;
  ...
  public static MsgType forNumber(int value) {
    switch (value) {
      ...
      case 6: return MSG_TYPE_PERSION;
      case 7: return MSG_TYPE_JOIN_GROUP;
      default: return null;
    }
  }
  ...
  // @@protoc_insertion_point(enum_scope:src.main.proto.MsgType)
}
